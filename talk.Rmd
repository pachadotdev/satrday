...
![Hex sticker](images/hexicon.png)
...
* In this model $\sigma$ represents the elasticity of substitution between all goods. 
...
```{r pikachu}
knitr::include_graphics("images/pikachu.jpg", dpi = 350)
```
...
```{r ddm_code_1, eval=FALSE, echo=TRUE}
...
```{r ddm_code_2, eval=FALSE, echo=TRUE}
# Checks
...
```{r ddm_code_3, eval=FALSE, echo=TRUE}
...
```{r ddm_code_4, eval=FALSE, echo=TRUE}
